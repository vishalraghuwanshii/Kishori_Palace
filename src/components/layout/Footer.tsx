      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-24">
          <Link href="/" className="inline-block mb-12">
            <Image src="https://pub-d85a0963552a45eaa4638691f287aaaa.r2.dev/images/logo.webp" alt="Kishori Palace Logo" width={240} height={100} className="object-contain w-auto h-24" />
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left mb-12 md:mb-24 border-t border-b border-border py-12">
          ...
          <div className="flex flex-col items-center md:items-start md:border-l md:border-border md:pl-12">
            ...
            <a href="tel:+917880291335" className="text-sm text-muted-foreground font-light hover:text-primary transition-colors mb-2 block">+91 78802 91335</a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground uppercase tracking-[0.1em]">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/kishori_palace/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Instagram</a>
