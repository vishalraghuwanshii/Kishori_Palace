    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed bottom-20 md:bottom-8 right-4 md:right-8 z-40 bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_12px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_16px_rgba(37,211,102,0.6)] hover:-translate-y-1 transition-all hidden md:flex items-center justify-center group"
