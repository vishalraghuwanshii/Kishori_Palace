    ...
    <section ref={ref} className="relative h-screen w-full flex items-center justify-center">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center pt-24">
        <motion.div
          ...
          className="max-w-5xl flex flex-col items-center mt-[10vh]"
        >
          <div className="flex items-center gap-4 mb-8">
            <div className="w-12 h-px bg-white/40" />
            <p className="font-sans text-xs md:text-sm tracking-[0.3em] uppercase text-white">
              Welcome to Ashoknagar's Crown Jewel
            </p>
            <div className="w-12 h-px bg-white/40" />
          </div>
          
          <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light text-white leading-[1.1] mb-6 md:mb-10 drop-shadow-2xl">
            A Timeless <br className="hidden md:block" />
            <span className="italic text-white/90">Heritage</span>
          </h1>
          
          <p className="text-base md:text-lg text-white/80 leading-relaxed max-w-2xl font-light tracking-[0.05em] mb-8 md:mb-12 drop-shadow-md">
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.3em] text-white">Explore the Palace</span>
            <div className="w-[1px] h-12 bg-gradient-to-b from-white to-transparent mt-2 transition-all duration-500 group-hover:h-16" />
          </Link>
        </motion.div>
      </div>
    </section>
